...
def main(argv):
  ...
  # FLAGS.task = 1
  # actor_iterator1 = actor.actor_loop(env.create_environment)
  # FLAGS.task = 2
  # actor_iterator2 = actor.actor_loop(env.create_environment)
  # FLAGS.task = 3
  # actor_iterator3 = actor.actor_loop(env.create_environment)
  ...
  # FLAGS.task = 1
  # next(actor_iterator1)

  # FLAGS.task = 2
  # next(actor_iterator3)
  #
  # FLAGS.task = 3
  # next(actor_iterator3)
